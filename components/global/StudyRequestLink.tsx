  ...
  return (
    <>
      ...
      <Link
        ...
        className="study-request-btn fixed bottom-6 right-6 z-50 flex items-center justify-center rounded-full text-black px-4 py-1 font-bold bg-[#BFA045] hover:scale-110 transition-transform duration-200"
      >
        دراسة مبنى مجانية
      </Link>
    </>
